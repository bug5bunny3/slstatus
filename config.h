...
static const struct arg args[] = {
	...
	//{ wifi_essid,	"%s ",		"enp0s20f0u2" },
	//{ wifi_perc,	"%s",		"enp0s20f0u2" },
//	{ netspeed_rx,	"%s🔻",		"enp0s20f0u2" },
//	{ netspeed_tx,	"%s🔺",		"enp0s20f0u2" },
...
//	{ run_command,	"%s ",		"echo $(awk '/MemTotal/{printf \"%.1f\",$2/1024}' /proc/meminfo)-$(awk '/MemAvailable/{printf \"%.1f\",$2/1024}' /proc/meminfo)|bc" },
	//{ run_command,	"%s",		"free|awk '/Mem:/{printf \"%.1f\", ($2-$7)/1024}'" },
	//{ swap_used,	"%s|",		"NULL" },
	//{ disk_used,	"%s|",		"/" },
	//{ wifi_essid,	"%s",		"wlp1s0"},
	//{ wifi_perc,	"📶%s",		"wlp1s0"},
